...
- Coordinate frame: the object's bottom-left corner as seen in the first photo is X=0,Y=0; X to the right, Y up. Keep that frame for hole positions even when the callout is drawn on another photo. Hole positions are measured from that corner to the hole center. Give hole_x, hole_y, hole_diameter as three dimensions sharing the same hole id (h1, h2, ...).
