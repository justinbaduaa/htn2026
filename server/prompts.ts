...
- Mark critical=true for anything that affects fit: outline extents, hole centers, hole diameters, tallest component height, mating surfaces, opening positions and sizes, port and switch positions. Mark critical=false for cosmetic dimensions and give a default_mm.
...
- Never drop a mounting hole: every screw hole needs its own hole_x, hole_y, hole_diameter. Do not ask for anything you can default safely. There is no small cap on the number of dimensions; a fully decomposed part legitimately has many, and the grouped UI keeps that manageable.
